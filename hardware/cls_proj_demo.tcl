...
#
# cls_proj_demo.tcl: Tcl script for re-creating project 'cls_proj_demo'
#
# Generated by Vivado on Thu Jun 12 15:27:56 PDT 2025
...
#
# 1. This project restoration tcl script (cls_proj_demo.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/troy/CLS_demo-/hardware/cls_proj_demo/cls_proj_demo.srcs/constrs_1/imports/constraints/Zybo-z7.xdc"
#    "/home/troy/CLS_demo-/hardware/cls_proj_demo/cls_proj_demo.srcs/utils_1/imports/synth_1/zynq_system_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/cls_proj_demo/cls_proj_demo.srcs/constrs_1/imports/constraints/Zybo-z7.xdc"]"\
 "[file normalize "$origin_dir/cls_proj_demo/cls_proj_demo.srcs/utils_1/imports/synth_1/zynq_system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "cls_proj_demo"
...
set script_file "cls_proj_demo.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/cls_proj_demo"]"
...
set file "[file normalize ${origin_dir}/cls_proj_demo/cls_proj_demo.srcs/constrs_1/imports/constraints/Zybo-z7.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "constraints/Zybo-z7.xdc"
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PmodCLS_0/ext_spi_clk] [get_bd_pins PmodCLS_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins PmodCLS_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
...
if { [get_property IS_LOCKED [ get_files -norecurse zynq_system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/cls_proj_demo/cls_proj_demo.gen/sources_1/bd/zynq_system/hdl/zynq_system_wrapper.vhd" ]
} else {
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/cls_proj_demo.srcs/utils_1/imports/synth_1/zynq_system_wrapper.dcp" -objects $obj
